(function(){
    ...
    let divTable = document.createElement('div');divTable.setAttribute('class','table');
    let table = document.createElement('table');

    let pagenumbers = document.createElement('div');
    pagenumbers.setAttribute('class','pagenumbers');
    pagenumbers.setAttribute('id','pagination');
    divTable.append(table);
    main.append(divTable,pagenumbers);
...
const list_items = [
  ...
  function displayList(items, table, rows_per_page, page){
  ...
  function SetupPagination (list_items, wrapper, rows_per_page)
  {
      wrapper.innerHTML = '';
      let page_count = Math.ceil(list_items.length / rows_per_page);

      /*for each 10 rows it calls paginationButton code to setup pagination button*/
  ...
  function paginationButton (page, list_items) {
    ...
    /*initally page 1 is selected so it is turned active*/
	...
	button.addEventListener('click', function () {
        ...
        /*display the respective list for the clicked button*/
        displayList(list_items, table, rows, current_page);
        
        /*clears out all other active buttons*/
		let current_btn = document.querySelector('.pagenumbers button.active');
        current_btn.classList.remove('active');
        
        /*makes the current button to active*/
